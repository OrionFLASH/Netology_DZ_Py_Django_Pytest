# Тестирование Django-приложения (исходное задание Нетологии)

Источник: [netology-code/dj-homeworks](https://github.com/netology-code/dj-homeworks), ветка `video`, путь `3.4-django-testing/django_testing`.
...
## Запуск проекта (из исходного задания)

- Установить зависимости: `pip install -r requirements-dev.txt`
- Создать базу в Postgres и выполнить: `manage.py migrate`
